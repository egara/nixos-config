...
''
    Variants {
        ...
        PanelWindow {
            ...
            property bool isTargetScreen: monitorManagerTargetScreen === "" || modelData.name === monitorManagerTargetScreen
            visible: isTargetScreen && (monitorManagerActive || modalCard.opacity > 0)
